...
describe('CartShowComponent', () => {
	...
	it('should decrease item quantity when the minus button is clicked', () => {
		...
		const minusButton = fixture.debugElement.nativeElement.querySelector('.fa-circle-minus');
		minusButton.click();
		fixture.detectChanges();
	...
	it('should increase item quantity when the plus button is clicked', () => {
		...
		const plusButton = fixture.debugElement.nativeElement.querySelector('.fa-circle-plus');
		plusButton.click();
		fixture.detectChanges();
